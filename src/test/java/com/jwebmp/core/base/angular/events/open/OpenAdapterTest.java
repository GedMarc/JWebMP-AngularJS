...
package com.jwebmp.core.base.angular.events.open;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-open=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_open_OpenAdapterTest$1');" + "\"></div>",
				test.toString(0));
	}
