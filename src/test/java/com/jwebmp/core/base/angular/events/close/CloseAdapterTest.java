...
package com.jwebmp.core.base.angular.events.close;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-close=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_close_CloseAdapterTest$1');" +
				"\"></div>",
				test.toString(0));
	}
