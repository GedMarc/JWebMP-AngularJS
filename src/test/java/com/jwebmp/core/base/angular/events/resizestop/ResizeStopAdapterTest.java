...
package com.jwebmp.core.base.angular.events.resizestop;
...
public class ResizeStopAdapterTest
		extends BaseTest
{
	@Test
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-resize-stop=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_resizestop_ResizeStopAdapterTest$1');\"></div>",
				test.toString(0));
	}
