...
package com.jwebmp.core.base.angular.events.search;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-search=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_search_SearchAdapterTest$1')" + ";" +
				"\"></div>",
				test.toString(0));
	}
