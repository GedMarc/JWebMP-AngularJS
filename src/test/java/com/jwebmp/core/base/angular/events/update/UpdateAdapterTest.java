...
package com.jwebmp.core.base.angular.events.update;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-update=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_update_UpdateAdapterTest$1')" + ";" +
				"\"></div>",
				test.toString(0));
	}
