...
package com.jwebmp.core.base.angular.events.resizestart;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-resize-start=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_resizestart_ResizeStartAdapterTest$1');\"></div>",
				test.toString(0));
	}
