...
package com.jwebmp.core.base.angular.events.selecting;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-selecting=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_selecting_SelectingAdapterTest$1');\"></div>",
				test.toString(0));
	}
