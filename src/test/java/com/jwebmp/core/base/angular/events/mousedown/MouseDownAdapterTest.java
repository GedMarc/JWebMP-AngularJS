...
package com.jwebmp.core.base.angular.events.mousedown;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-mousedown=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_mousedown_MouseDownAdapterTest$1');\"></div>",
				test.toString(0));
	}
