...
package com.jwebmp.core.base.angular.events.complete;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-complete=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_complete_CompleteAdapterTest$1');\"></div>",
				test.toString(0));
	}
