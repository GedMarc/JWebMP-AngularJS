...
package com.jwebmp.core.base.angular.events.slide;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-slide=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_slide_SlideAdapterTest$1');" +
				"\"></div>",
				test.toString(0));
	}
