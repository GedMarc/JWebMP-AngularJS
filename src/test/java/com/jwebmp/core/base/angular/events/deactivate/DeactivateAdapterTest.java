...
package com.jwebmp.core.base.angular.events.deactivate;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-de-activate=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_deactivate_DeactivateAdapterTest$1');\"></div>",
				test.toString(0));
	}
