...
package com.jwebmp.core.base.angular.events.beforeclose;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-before-close=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_beforeclose_BeforeCloseAdapterTest$1');\"></div>",
				test.toString(0));
	}
