...
package com.jwebmp.core.base.angular.events.load;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-load=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_load_LoadAdapterTest$1');" + "\"></div>",
				test.toString(0));
	}
}
