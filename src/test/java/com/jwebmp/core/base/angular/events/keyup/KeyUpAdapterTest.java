...
package com.jwebmp.core.base.angular.events.keyup;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-keyup=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_keyup_KeyUpAdapterTest$1');" +
				"\"></div>",
				test.toString(0));
	}
