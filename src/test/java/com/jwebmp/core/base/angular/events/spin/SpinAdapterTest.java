...
package com.jwebmp.core.base.angular.events.spin;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-spin=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_spin_SpinAdapterTest$1');" + "\"></div>",
				test.toString(0));
	}
