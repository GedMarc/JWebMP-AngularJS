...
package com.jwebmp.core.base.angular.events.blur;
		...
		extends BaseTest
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-blur=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com_jwebmp_core_base_angular_events_blur_BlurAdapterTest$1');" + "\"></div>",
				test.toString(0));
	}
