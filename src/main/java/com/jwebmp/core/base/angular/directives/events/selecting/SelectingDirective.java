 ...
 * @since 25 Jun 2016
 */
public class SelectingDirective
		extends AngularDirectiveBase<SelectingDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(SelectingDirective.class, "Selecting", "Selecting.min.js")
		                    .toString();
	}
