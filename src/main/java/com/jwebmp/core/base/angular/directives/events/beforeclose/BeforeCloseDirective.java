 ...
 * @since 25 Jun 2016
 */
public class BeforeCloseDirective
		extends AngularDirectiveBase<BeforeCloseDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(BeforeCloseDirective.class, "BeforeClose", "BeforeClose.min.js")
		                    .toString();
	}
