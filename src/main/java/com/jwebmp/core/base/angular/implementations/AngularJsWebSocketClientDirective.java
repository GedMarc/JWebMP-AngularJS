 ...
 * @since 25 Jun 2016
 */
public class AngularJsWebSocketClientDirective
		extends AngularDirectiveBase<AngularJsWebSocketClientDirective>
{
	...
	{
		return getFileTemplate(getClass(),"WebSocketListener", "websocketlistener.min.js")
				       .toString();
	}
