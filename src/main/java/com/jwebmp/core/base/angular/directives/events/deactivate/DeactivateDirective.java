 ...
 * @since 25 Jun 2016
 */
public class DeactivateDirective
		extends AngularDirectiveBase<DeactivateDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(DeactivateDirective.class, "Deactivate", "Deactivate.min.js")
		                    .toString();
	}
