 ...
 * @since 25 Jun 2016
 */
public class ResizeStartDirective
		extends AngularDirectiveBase<ResizeStartDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(ResizeStartDirective.class, "ResizeStart", "ResizeStart.min.js")
		                    .toString();
	}
