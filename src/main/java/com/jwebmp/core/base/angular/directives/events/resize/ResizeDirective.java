 ...
 * @since 25 Jun 2016
 */
public class ResizeDirective
		extends AngularDirectiveBase<ResizeDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(ResizeDirective.class, "Resize", "Resize.min.js")
		                    .toString();
	}
