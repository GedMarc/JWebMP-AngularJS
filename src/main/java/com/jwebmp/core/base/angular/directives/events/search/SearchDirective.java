 ...
 * @since 25 Jun 2016
 */
public class SearchDirective
		extends AngularDirectiveBase<SearchDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(SearchDirective.class, "Search", "Search.min.js")
		                    .toString();
	}
