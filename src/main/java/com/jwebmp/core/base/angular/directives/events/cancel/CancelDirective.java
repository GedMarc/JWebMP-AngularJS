 ...
 * @since 25 Jun 2016
 */
public class CancelDirective
		extends AngularDirectiveBase<CancelDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(CancelDirective.class, "Cancel", "Cancel.min.js")
		                    .toString();
	}
