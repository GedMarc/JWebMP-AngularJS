 ...
 * @since 25 Jun 2016
 */
public class DropDirective
		extends AngularDirectiveBase<DropDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(DropDirective.class, "Drop", "Drop.min.js")
		                    .toString();
	}
