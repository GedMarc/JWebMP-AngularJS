 ...
 * @since 25 Jun 2016
 */
public class DropOverDirective
		extends AngularDirectiveBase<DropOverDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(DropOverDirective.class, "DropOver", "DropOver.min.js")
		                    .toString();
	}
