 ...
 * @author Marc Magon
 */
public abstract class SelectingEvent<J extends SelectingEvent<J>>
		extends SelectingAdapter<J>
		implements GlobalEvents
{
	 ...
	 */
	public SelectingEvent(Component component)
	{
		super(component);
	...
	public void preConfigure()
	{
		if (getComponent() != null)
		{
			...
			getComponent().addAttribute(AngularAttributes.ngSelecting,
	...
	public SelectingDirective getDirective()
	{
		if (directive == null)
		{
			directive = new SelectingDirective();
		}
		return directive;
	}
