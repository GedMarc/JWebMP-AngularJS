...
import static com.jwebmp.core.FileTemplates.getFileTemplate;
 ...
 * @since 25 Jun 2016
 */
public class InitialisedDirective
		extends AngularDirectiveBase<InitialisedDirective>
{
	...
	{
		return getFileTemplate(getClass(),"Initialised", "Initialised.min.js")
				       .toString();
	}
