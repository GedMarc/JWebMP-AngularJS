		...
		implements IOnCloseService<OnClose>
{
	...
	public void onCreate(Event<?, ?> e)
	{
		...
		{
			e.getComponent().asAttributeBase().addAttribute(String.valueOf(AngularAttributes.ngClose), com.jwebmp.core.utilities.StaticStrings.STRING_ANGULAR_EVENT_START
