 ...
 * @since 25 Jun 2016
 */
public class RightClickDirective
		extends AngularDirectiveBase<RightClickDirective>
{
	...
	{
		return FileTemplates.getFileTemplate(RightClickDirective.class, "RightClick", "RightClick.min.js")
		                    .toString();
	}
